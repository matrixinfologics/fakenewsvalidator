...
class TwitterUser{
    ...
    var $max_friends_count;

    var $max_followers_count;

    var $max_tweets;



    function __construct($consumer_key,$consumer_secret,$oauth_token,$oauth_secret,$user_screen_name){
    ...
    function getUserTweets($screen_name){
        ...
        while(true){
            ...
            if (count($user_timeline)) {
                ...
                //$user_info->last_tweet_datetime = $last_tweet->created_at;
    ...
    function get_all_users_in_timeline($arr_screen_names){
    ...
    function usersLookupName($screen_name){
